...
function createDailyForecastCards(forecastData) {
    ...
    weekdays.forEach(weekday => {
        ...
        highTempCont.innerHTML = `H: ${highTemp} &#176 `;
        lowTempCont.innerHTML = `L: ${lowTemp} &#176 `;
...
function getWeatherConditionIcon(weatherCondition, formattedHour, sunsetTime, sunriseTime) {
    ...
    } else if ( weatherCondition === 'Moderate rain' || weatherCondition === 'Patchy light drizzle' || weatherCondition === 'Light rain shower' || weatherCondition === 'Mist' || weatherCondition === 'Light rain') {
        return rainIcon;
